...
public class ImovelViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImovelViewHolder(@NonNull View itemView) {
        ...
        quantidadeQuarto = itemView.findViewById(R.id.imovel_quantidadeQuarto);
        vagasGaragem = itemView.findViewById(R.id.imovel_vagasGaragem);
        telefoneContato = itemView.findViewById(R.id.imovel_telefoneContato);
